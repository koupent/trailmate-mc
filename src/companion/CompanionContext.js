...
import { BoatPassengerController } from './movement/BoatPassengerController.js';
...
export class CompanionContext {
    ...
    constructor(agent, worldState, config) {
        ...
        this.boatPassenger = new BoatPassengerController(agent.bot, this.movement);
         ...
         *   priorityOrigin?: { x: number, y: number, z: number } | null,
         *   pickupSettle?: {
         *     targetKey: number|string|object,
         *     startedAt: number,
         *     settleMs: number
         *   } | null
         * }} nearby ground-item scavenging */
        this.nearbyLoot = {
            active: false,
            suppressUntil: 0,
            priorityUntil: 0,
